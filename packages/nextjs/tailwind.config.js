  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        "neo": "4px 4px 0px 0px rgba(0,0,0,1)",           // Neo-Brutalism Shadow
        "neo-sm": "2px 2px 0px 0px rgba(0,0,0,1)",        // Small Neo Shadow
        "neo-lg": "6px 6px 0px 0px rgba(0,0,0,1)",        // Large Neo Shadow
      },
      borderRadius: {
        "neo": "0px", // Sharp corners
      },
      borderWidth: {
        "neo": "2px", // Thick borders
      },
      animation: {
